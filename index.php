        ...
        <div class="container aside-xl"> <a class="navbar-brand block" href="index.html">Sign in from here</a>
            <section class="m-b-lg">
                ...
                <?php  
                    ...
                    if( isset($_POST['submit']) ){
                        ...
                        if( empty($euname) || empty($pass) ){
                            ...
                            $mess = $obj -> adminLogin($euname, $pass);                              
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    ...
                    <div class="text-center m-t m-b"><a href="password_reset.php"><small>Forgot password?</small></a></div>


                    <div class="line line-dashed"></div>
                    <p class="text-muted text-center"><small>Do not have an account?</small></p> 
                    <a href="registration.php" class="btn btn-lg btn-default btn-block">Create an account</a> 
                </form>
